...
<body>
	...
	<form action="http://<?php echo $_SERVER['SERVER_NAME'] . $script_name; ?>">
	...
	<div id="flash">
		<table class="compact cell-border" style="font-size: 0.8em;" id="WeatherTable">
		<thead>
			<th>Date</th>
			<th>Air Temp</th>
			<th>Dew Point</th>
